...
@ApplicationScoped
public class TopupAmountRepository implements PanacheRepository<Topup> {

    public Uni<List<TopupMonthAmount>> findMonthlyTopupAmounts(Long year) {
        String sql = """
                WITH months AS (
    ...
    public Uni<List<TopupYearAmount>> findYearlyTopupAmounts(Long year) {
        String sql = """
                WITH years AS (
