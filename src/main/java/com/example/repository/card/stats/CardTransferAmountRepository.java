...
@ApplicationScoped
public class CardTransferAmountRepository implements PanacheRepository<Card> {

    public Uni<List<CardMonthAmount>> getMonthlyTransferAmountSender(LocalDate yearDate) {
        String sql = """
                WITH months AS (
    ...
    public Uni<List<CardMonthAmount>> getMonthlyTransferAmountReceiver(LocalDate yearDate) {
        String sql = """
                WITH months AS (
                    SELECT 1 AS m UNION ALL SELECT 2 UNION ALL SELECT 3 UNION ALL SELECT 4 UNION ALL
                    SELECT 5 UNION ALL SELECT 6 UNION ALL SELECT 7 UNION ALL SELECT 8 UNION ALL
    ...
    public Uni<List<CardYearAmount>> getYearlyTransferAmountSender(Long year) {
        String sql = """
                WITH years AS (
    ...
    public Uni<List<CardYearAmount>> getYearlyTransferAmountReceiver(Long year) {
        String sql = """
                WITH years AS (
                    SELECT :year - 4 AS y UNION ALL
                    SELECT :year - 3 AS y UNION ALL
