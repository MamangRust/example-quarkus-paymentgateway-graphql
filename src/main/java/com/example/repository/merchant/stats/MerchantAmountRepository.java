...
@ApplicationScoped
public class MerchantAmountRepository implements PanacheRepository<Merchant> {

    public Uni<List<MerchantMonthlyAmount>> findMonthlyAmount(Long year) {
        String sql = """
                WITH months AS (
    ...
    public Uni<List<MerchantYearlyAmount>> findYearlyAmount(Long year) {
        String sql = """
                WITH years AS (
